  ...
  .controller('TPJobSearchCtrl', function ($scope, $http, apiService, util, locale) {
    locale.ready('common').then(function () {
      ...
      var columns = [
        ...
        { dataField: 'TechnicianName',      caption: locale.getString('common.CP_JobsGrid_TechnicianName'), visible: false },
        { dataField: 'TechnicianId',      caption: locale.getString('common.CP_JobsGrid_TechnicianId'), visible: false },
